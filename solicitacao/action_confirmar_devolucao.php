<?php
	...
	if(isset($_SESSION['idCliente'])){
		...
		if(isset($_POST['emprestimo_data_devolucao'])){
			$dataDev = $_POST['emprestimo_data_devolucao'];
			...
			if($nivel == "adm"){
				...
				$emprestimo->confirmarDevolucao($dataDev, $idEmprestimo, $idCliente, $observacoes);
