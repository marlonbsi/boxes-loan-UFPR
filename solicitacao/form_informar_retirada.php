<html>
	...
	<body>
		...
		?>
					...
					<form action="action_informar_retirada.php" class="formRetirada" method="post">
						<div class="formLinhaA">
							<h1>Informar Retirada de Empréstimo</h1>
						</div>
						<div class="formLinha">
							<label>Data da retirada:</label> <input type="text" id="calendario_ret" name="emprestimo_data_retirada" class="input2" readonly="readonly"/>						</div>
						<div class="formTextAreaP">
							<label>Observações:</label> <br/>
							<textarea name="obs" rows="6" cols="80" maxlength="400"></textarea>
						</div>
